    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courseDuration', models.DecimalField(decimal_places=2, default=0.0, max_digits=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('staff', 'Staff'), ('student', 'Student')], default='staff', max_length=10, null=True)),
